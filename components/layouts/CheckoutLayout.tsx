        ...
        <>
            <section aria-labelledby="summary-heading" className="hidden w-full max-w-md flex-col bg-gray-50 lg:flex">
                <h2 id="summary-heading" className="sr-only">
                    {lang.checkout.order.title}
                </h2>

                <ul role="list" className="flex-auto divide-y divide-gray-200 overflow-y-auto px-6">
                    {cart.items.map((product) => (
                        <li key={product.uuid} className="flex space-x-6 py-6">
                            <div className="h-40 w-40 overflow-hidden flex-none rounded-md bg-gray-200 object-cover object-center">
                ...
                <div className="mt-1 flex space-x-4">
                  ...
                  >
                    ...
                    <dl className="mt-10 space-y-6 text-sm font-medium text-gray-500">
                        <div className="flex justify-between">
                            <dt>{lang.checkout.order.sub_total}</dt>
                            <dd className="text-gray-900">{cart.order.total}€</dd>
                        </div>
                        {/* <div className="flex justify-between">
                  <dt className="flex">
                    Discount
                ...
                <div className="flex justify-between">
                  ...
                  <dd className="text-gray-900">{shipping}</dd>
                        ...
                        <div className="flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                            <dt>{lang.checkout.order.total}</dt>
                            <dd className="text-base">{cart.order.total}€</dd>
                        </div>
                    </dl>
                </div>
            </section>
